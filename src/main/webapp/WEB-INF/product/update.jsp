...
<div class="container my-5">
    <h2>Cập Nhật ${productType == 'stationery' ? 'Văn Phòng Phẩm' : 'Sách'} (Admin)</h2>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <p class="text-muted mt-1">Ảnh hiện tại: ${product.imageUrl}</p>
                </div>
                <div class="mb-3">
                ...
                <c:choose>
                    <c:when test="${productType == 'book'}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="publicationYear" name="publicationYear" value="${product.publicationYear}">
                        </div>
                        <div class="mb-3">
                            <label for="numberOfPages" class="form-label">Số trang</label>
                            <input type="number" class="form-control" id="numberOfPages" name="numberOfPages" value="${product.numberOfPages}">
                        </div>
                        <div class="mb-3">
                            <label for="coverType" class="form-label">Loại bìa</label>
                            <input type="text" class="form-control" id="coverType" name="coverType" value="${product.coverType}">
                        </div>
                        <div class="mb-3">
                            <label for="language" class="form-label">Ngôn ngữ</label>
                            <input type="text" class="form-control" id="language" name="language" value="${product.language}">
                        </div>
                    </c:when>
                    <c:when test="${productType == 'stationery'}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="specifications" name="specifications" rows="2">${product.specifications}</textarea>
                        </div>
                        <div class="mb-3">
                            <label for="warning" class="form-label">Cảnh báo (nếu có)</label>
                            <input type="text" class="form-control" id="warning" name="warning" value="${product.warning}">
                        </div>
                    </c:when>
                </c:choose>
            </div>

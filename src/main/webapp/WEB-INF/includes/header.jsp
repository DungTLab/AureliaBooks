            ...
            <div class="container"> 
                <div class="d-flex w-100 align-items-center justify-content-between gap-4">
                    ...
                    <div class="d-flex align-items-center">
                        <a href="http://localhost:8080/AureliaBooks/" class="navbar-brand me-0">
                            <img src="./assets/images/Logo/main-logo.png" alt="AureliaBooks" class="img-logo" style="height: 50px;"/>
                        </a>
                    </div>
                    ...
                    <div class="d-none d-lg-flex align-items-center gap-4">
                        ...
                        <a href="#" class="nav-link d-flex align-items-center gap-2 text-secondary position-relative py-2">
                        ...
                        <a href="#" class="nav-link d-flex align-items-center gap-2 text-secondary py-2">

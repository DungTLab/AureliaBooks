...
<div class="container my-5" style="max-width: 500px;">
    <div class="card shadow-sm border-danger">
        <div class="card-header bg-danger text-white py-3">
            <h5 class="card-title mb-0">Xác Nhận Xóa Nhà Cung Cấp</h5>
        </div>
        <div class="card-body p-4 text-center">
            ...
            <form action="${pageContext.request.contextPath}/admin/suppliers?view=delete" method="POST" class="mt-4">
                ...
                <div class="d-flex justify-content-center gap-3">
                    <a href="${pageContext.request.contextPath}/admin/suppliers" class="btn btn-secondary px-4 py-2">Hủy Bỏ</a>
